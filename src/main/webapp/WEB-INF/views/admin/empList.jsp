		...
		<form name="searchForm" action="empList.do" method="get" class="form-inline pull-right" style="padding-top: 5px; padding-right: 5px;">
		  <div class="form-group">
		    ...
		    <div class="input-group">		    
		      <input type="text" class="form-control" id="keyword" name="keyword" value="${param.keyword}" placeholder="twopacks" style="height: 35px;">
		    </div>
		  </div>
...
<%-- 									<td>${fn:length(conList)-status.index}</td> --%>
									...
									<td><a href="empListDetail.do?id=${list.empId}"><c:out value="${list.empId}"/></a></td>
